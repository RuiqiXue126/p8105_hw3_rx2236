...
![](p8105_hw3_rx2236_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
Similarly, we get states that were observed at 7 or more locations in
...
``` r
merged_df2 |>
  group_by(seqn, age, education) |>
  summarise(total = sum(mims_value)) 
```

    ## `summarise()` has grouped output by 'seqn', 'age'. You can override using the
    ## `.groups` argument.

    ## # A tibble: 228 × 4
    ## # Groups:   seqn, age [228]
    ##     seqn   age education               total
    ##    <dbl> <dbl> <ord>                   <dbl>
    ##  1 62161    22 High school equivalent 13194.
    ##  2 62164    44 More than high school  13411.
    ##  3 62169    21 High school equivalent  9991.
    ##  4 62174    80 More than high school   8579.
    ##  5 62177    51 High school equivalent 11918.
    ##  6 62178    80 High school equivalent  7489.
    ##  7 62180    35 More than high school  14205.
    ##  8 62184    26 High school equivalent 13599.
    ##  9 62189    30 More than high school  18551.
    ## 10 62199    57 More than high school  14548.
    ## # ℹ 218 more rows
